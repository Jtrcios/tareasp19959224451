...
eliminarRegistro( creditoEntSal );
break;
...
if ( cliente.gobtenerNumeroCuenta() != 0 ) // omite los registros vacíos
...
if ( cliente.gobtenerNumeroCuenta() != 0 ) 
{
...
cliente.establecerSaldo( saldoAnterior + transaction );
imprimirLinea( cout, cliente ); // muestra el registro
...
{
salida << left << setw( 10 ) << registro.gobtenerNumeroCuenta()
