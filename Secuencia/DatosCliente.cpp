...
DatosCliente::DatosCliente( int valorNumeroCuenta, const string 
&apellidoPaterno, 
onst string &primerNombre, double valorSaldo )
...
void DatosCliente::establecerApellidoPaterno( const string 
